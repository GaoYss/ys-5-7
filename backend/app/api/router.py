...
from app.api.routes import expiration, gifts, members, points, tiers, vouchers
...
api_router.include_router(expiration.router, prefix="/expiration", tags=["expiration"])
